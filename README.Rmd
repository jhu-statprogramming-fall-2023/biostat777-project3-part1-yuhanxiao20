...
Original author: Nassos Stylianou, Clara Guibourg, Will Dahlgreen, Robert Cuffe, Tom Calver, Ransome Mpini (package).

URL to the GitHub link to where the original R package came from: https://github.com/bbc/bbplot.

URL to the deployed website: https://jhu-statprogramming-fall-2023.github.io/biostat777-project3-part1-yuhanxiao20/.
...
2. I used `bslib` to customize the height of the navigation bar to 100px.
3. I set up development `mode` to auto.
4. I used sidebar `structure` to add a GitHub link next to the search box.
...
![Example of graphics created using the bbplot package](man/figures/bbplot_example_plots.png)
